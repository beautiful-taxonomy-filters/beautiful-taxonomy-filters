...
<div class="wrap">
    ...
    <ol>
		...
		<li>
			<p><?php _e('To use the dropdown filter module you can either use the widgets or copy:', 'beautiful-taxonomy-filters'); ?> <pre><code>&lt;?php if(function_exists('show_beautiful_filters')){ show_beautiful_filters(); } ?&gt;</code></pre> <?php _e('and paste it in your', 'beautiful-taxonomy-filters'); ?> <a href="<?php echo get_admin_url() . 'theme-editor.php?file=archive.php'; ?>" target="_blank">archive.php</a> <?php _e('file in your template. It should be placed somewhere above', 'beautiful-taxonomy-filters'); ?> <pre><code>&lt;?php if( have_posts() ) : ?&gt;</code></pre></p>
		...
		<li>
			<p><?php _e('To show the active filter info either use the widgets or copy:', 'beautiful-taxonomy-filters'); ?> <pre><code>&lt;?php if(function_exists('show_beautiful_filters_info')){ show_beautiful_filters_info(); } ?&gt;</code></pre> <?php _e('to wherever you want the filter info to appear.', 'beautiful-taxonomy-filters'); ?></p>
		</li>
	</ol>
</div>
